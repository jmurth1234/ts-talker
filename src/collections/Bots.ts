          ...
          fields: [
            {
              ...
              admin: {
                description: 'This is a function that will be called to generate a primer for the bot. This allows us to steer the bot output',
              }
            },
            {
              ...
              relationTo: "functions",
              admin: {
                description: 'This is a function that will be called to generate a response template for the bot. This allows us to steer the bot output',
              }
            },
            {
              name: "chance",
